module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    shell: {
      ...
      standalone: {
        command: 'component build --standalone ListExportable -n list.exportable.standalone'
      },
      mkdir: {
        command: 'mkdir -p dist'
      },
      move: {
        command: 'mv build/list.exportable.standalone.js dist/list.exportable.js'
      },
      remove: {
    ...
    uglify: {
      target: {
        files: {
          'dist/list.exportable.min.js': ['dist/list.exportable.js']
        }
      }
    },
    mocha: {
